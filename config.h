...
static const int animationframes    = 7;        /* Amount of frames the animations should take per window. */
static const int framereduction     = 1;        /* Amount of frames, the animation should be reduced by, per new Client. */
static const int frreducstart       = 5;        /* After how many Clients should the animation time be decreased? */
